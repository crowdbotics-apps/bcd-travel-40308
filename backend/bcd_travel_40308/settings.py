"""
Django settings for bcd_travel_40308 project.
...
ROOT_URLCONF = 'bcd_travel_40308.urls'
...
WSGI_APPLICATION = 'bcd_travel_40308.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bcd_travel_40308 API",
    "DESCRIPTION": "API documentation for bcd_travel_40308 App",
    "VERSION": "v1",
}
